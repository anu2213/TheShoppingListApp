    ...
    LazyColumn(
        ...
        item {
            ...
            Button(
                ...
                modifier = Modifier.padding(top = 32.dp) // Adjust the dp as needed
            ) {
                Text("Add Item")
            }
        ...
        items(sItems) {
            // Your shopping list items would go here
          item->
            if(item.isEditing){
                ShoppingItemEditor(
                    item=item,onEditComplete={
                ...
                ShoppingListItem(item=item,onEditClick={
                    //finding out exactly which item we are editing and changing is"isEditingboolean to true
...
fun ShoppingListItem(
    ...
    Row(
        modifier = Modifier.padding(8.dp).fillMaxWidth().border(
            border = BorderStroke(2.dp, Color(0xFFF01878)),
